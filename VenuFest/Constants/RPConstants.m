...
//Oswald-Bold
NSString  *TOP_BAR_TITLE_FONT_NAME =  @"AvantGradeBkBt";          // @"ROBOTO-REGULAR";
CGFloat TOP_BAR_TITLE_FONT_SIZE = 20.f;

NSString  *BOTTOM_BAR_TITLE_FONT_NAME = @"AvantGrade Bk BT";       // @"ROBOTO-REGULAR";
CGFloat BOTTOM_BAR_TITLE_FONT_SIZE = 14.f;

NSString  *TAB_BAR_TITLE_FONT_NAME =   @"AvantGrade Bk BT";       // @"ROBOTO-REGULAR";
CGFloat TAB_BAR_TITLE_FONT_SIZE = 14.0f;

NSString  *APPLICATION_TEXTFIELD_FONT_NAME =   @"AvantGrade Bk BT";     //  @"ROBOTO-REGULAR";
...
NSString  * APPLICATION_BODY_FONT_NAME =  @"AvantGrade Bk BT";         // @"ROBOTO-REGULAR";
...
NSString * FACEBOOK_API_CALLBACK_URL_SCHEME = @"fb1102272459838268";
NSString * FACEBOOK_API_CALLBACK_NOTIFICATION = @"__FACEBOOK_API_CALLBACK_NOTIFICATION__";

NSString * GOOGLE_PLUS_API_CLIENT_ID =
@"1074928326212-7q4kjpeeatorb4vc8m9gk4i1315caj85.apps.googleusercontent.com";

NSString * GOOGLE_PLUS_API_CALLBACK_URL_SCHEME = @"com.sbrtech.RP";
//@"com.sbrtech.Debate";
