...
#define  DEFAULT_BACKGROUND_COLOR      [UIColor colorWithRed:0.0/255 green:0.0/255 blue:0.0/255 alpha:0.9]
...
//        self.detailsLabelText = @"Please Wait...";
        ...
        //changed suman
//		self.color = nil;
        self.color = DEFAULT_BACKGROUND_COLOR;

		self.labelFont = [UIFont boldSystemFontOfSize:kLabelFontSize];
		self.labelColor = [UIColor whiteColor];
        
        //changed suman
        self.detailsLabelFont = [UIFont fontWithName:@"Arial" size:kDetailsLabelFontSize];
